        ...
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                <div className='lg:w-1/2 relative'>
                    <img src={img1} className="max-w-sm rounded-lg shadow-2xl w-3/4" />
                    <img src={img2} className="max-w-sm rounded-lg shadow-2xl w-1/2 absolute right-5 top-1/2 border-8 border-white" />
                </div>
